...
class Menu:
    ...
    def start(self):
        ...
        while self.running:
            ...
            button.Button(self.display, "Start", self.display.get_width() // 2, 3.2 * self.display.get_height() // 8,
                          self.display.get_width() // 6, self.display.get_height() // 9, "black", "white", self.game,
                          "white", aqua)
            ...
            button.Button(self.display, "Proti počítači", 3 * self.display.get_width() // 8,
                          5.4 * self.display.get_height() // 8, self.display.get_width() // 5,
                          self.display.get_height() // 16, "black", "black", self.computer, self.color41, self.color42,
                          42)
            button.Button(self.display, "Proti protihráči", 5 * self.display.get_width() // 8,
                          5.4 * self.display.get_height() // 8, self.display.get_width() // 5,
                          self.display.get_height() // 16, "black", "black", self.person, self.color51, self.color52,
                          42)

            button.Button(self.display, "4x4", 3 * self.display.get_width() // 8, 4.5 * self.display.get_height() // 8,
                          self.display.get_width() // 12, self.display.get_height() // 16, "black", "black", self.small,
                          self.color11, self.color12, 42)
            button.Button(self.display, "8x8", self.display.get_width() // 2, 4.5 * self.display.get_height() // 8,
                          self.display.get_width() // 12, self.display.get_height() // 16, "black", "black",
                          self.medium, self.color21, self.color22, 42)
            button.Button(self.display, "12x12", 5 * self.display.get_width() // 8,
                          4.5 * self.display.get_height() // 8, self.display.get_width() // 12,
                          self.display.get_height() // 16, "black", "black", self.big, self.color31, self.color32, 42)

            button.Button(self.display, "Pravidla", self.display.get_width() // 2,
                          6.5 * (self.display.get_height() // 8), self.display.get_width() // 6,
                          self.display.get_height() // 9, "black", "white", self.help, "white", aqua)
